...
```text
                ...
                └─────────────┬─────────┘
                    ...
                    └──────────┬────────┘
                               ▼
        ┌─────────────────────────────────────────┐
        │ Select relevant ECU manual               │
        │ ECU-700 / ECU-800 Base / ECU-800 Plus   │
        └───────────────────┬─────────────────────┘
                            ▼
                 ┌───────────────────┐
                 │ Vectorstore       │
...
│   └── test-questions.csv
│
├── mlruns/                   # MLflow local model registry
│
├── src/
...
│       ├── log_model.py      # MLflow model export
│       ├── mlflow_model.py   # Inference wrapper for MLflow
│       ├── rag_chain.py      # RAG logic
│       ├── router.py         # Question routing
│       ├── sandbox_test.py   # Local debugging CLI
